...
echo "------------------------------------------------------------------------------"
echo "🌐 Frontend Access  : http://<YOUR-EC2-PUBLIC-IP>:4000"
echo "⚙️ Backend API Endpoint: http://<YOUR-EC2-PUBLIC-IP>:5000/api/health"
echo "👑 Admin Credentials: Username: admin | Password: Colon#2420"
echo "👤 User Credentials : Username: user  | Password: user123"
echo "=============================================================================="
