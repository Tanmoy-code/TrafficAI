...
public class DatabaseManager {
    ...
    public static void initDatabase() {
        try {
            ...
            if (dbUrl == null || dbUrl.isEmpty()) {
                dbUrl = "jdbc:mysql://localhost:3306/traffic_ai";
            }
            ...
            try {
                ...
                // Ignore driver loading exception and let DriverManager try
            }
            ...
            try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
                ...
                System.out.println("✅ Relational Database 'users' table initialized.");

                String countSql = "SELECT COUNT(*) FROM users";
                ResultSet rs = stmt.executeQuery(countSql);
                if (rs.next() && rs.getInt(1) == 0) {
                    System.out.println("🌱 Seeding initial user credentials into database...");
            ...
            System.out.println("⚠️ JDBC Connection unavailable locally: " + e.getMessage());
    ...
    private static Connection getConnection() throws SQLException {
        ...
        String dbUser = System.getenv("DB_USER") != null ? System.getenv("DB_USER") : "traffic_user";
        String dbPass = System.getenv("DB_PASS") != null ? System.getenv("DB_PASS") : "Traffic#2420";
